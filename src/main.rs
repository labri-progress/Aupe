...
fn main() {
    ...
    match opt.app {
// cargo run -- -T 10 -n 10 cms -O -G samples -f 10 -x 3 -t 3 -v 5 -u 5 -m 10 -n 10 -p 1
// cargo run -- -T 200 -n 1000 cms -O -G samples -f 10 -t 100 -x 10 -v 20 -u $20 -m 100 -n 1000 -p 1
        WhichApp::AupeCMS(pp) => {
