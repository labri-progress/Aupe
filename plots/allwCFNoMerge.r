...
data$Strat <- ifelse(data$dim != "Basalt" & data$dim != "Brahms" & data$dim != "omn" & data$dim != "cf", 
...
cf_colors <- c("#882EE6", "#C42EE6", "#AB6FEB")
...
#for (i in seq_along(trust_levels)) {custom_colors[paste("cms(", s, ",", k, ")(t=", trust_levels[i], "%)", sep = "")] <- cms_colors[i]}
